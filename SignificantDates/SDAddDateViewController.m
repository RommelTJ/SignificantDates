...
- (IBAction)saveButtonTouched:(UIBarButtonItem *)sender {
    if (![self.nameTextField.text isEqualToString:@""] && self.datePicker.date) {
        ...
        UIAlertController *cannotSaveAlert = [UIAlertController alertControllerWithTitle:@"Uh oh...." message:@"You must at least set a name and date." preferredStyle: UIAlertControllerStyleAlert];
        UIAlertAction *okButton = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:nil];
        [cannotSaveAlert addAction:okButton];
        [self presentViewController:cannotSaveAlert animated:YES completion:nil];
    }
